# About
**Bio**: I'm a Machine Learning Engineer/Researcher at [Verneek AI](https://www.verneek.com/), focusing on developing personalized e-commerce search. I hold a Master's in Computer Science from Georgia Tech, with a specialisation in Machine Learning and a keen interest in Natural Language Processing and its societal applications. Before joining Georgia Tech, I led applied speech recognition and synthesis research at Walmart India, playing a key role in developing a [multilingual voice assistant](https://stories.flipkart.com/use-voice-assistant-to-buy-groceries-flipkart/). My Computer Science academic journey began at IIT Varanasi, where I graduated with the second highest grades in my class. Please see my CV for more details.
