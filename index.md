...
<div id="research-content">
    <span id="research-brief-content">
        My current <i>research interests</i> lie in <strong>reasoning in LLMs</strong>, with a focus on characterizing and modeling the missing design attributes of human-like reasoning, such as abstraction and easy-to-hard generalization. In machine learning terms, my interests relate to efficient and adaptive abstractions, systematic generalization, and interpretability approaches for reasoning.
